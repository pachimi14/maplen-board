...
scripts/backfill.py                  resumable backfill: 31 items x itemUpgrade 0..21 x ~150 days (SH-22: 28 + 2, SH-30: +1)
...
GET /sf-history/equipment             31-item list (SH-22: 28 + 2, SH-30: +1) + aliasItemIds + aliases (itemId+itemName per group
...
- request budget: 700 per process run (616 = 28 items x 22 upgrades, plus
  retry headroom; SH-22's 2 additions add 44 more requests, SH-30's 1
  addition adds 22 more, still well under budget)
