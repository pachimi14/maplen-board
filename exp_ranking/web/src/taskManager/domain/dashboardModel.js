...
export function normalizeDashboardState(raw) {
  if (!raw || typeof raw !== "object" || ![1, DASHBOARD_SCHEMA_VERSION].includes(raw.schemaVersion)) {
    return createDefaultDashboardState();
  }
  const dailyExpGoals = raw.schemaVersion === DASHBOARD_SCHEMA_VERSION && raw.dailyExpGoals && typeof raw.dailyExpGoals === "object"
